      ...
      <>
        <div
          className={cn(
            ...
            "relative flex w-[7.5rem] shrink-0 flex-col items-center",
            className
          )}
        >
          <div ref={ref} className="relative h-32 w-24">
              ...
              {Array.from({ length: underCount }, (_, i) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      // Depth goes up/right so the top card shares the row baseline.
        ...
        {drag?.moved ? (
          <div
            className="pointer-events-none fixed z-[80] h-32 w-24 -translate-x-1/2 -translate-y-1/2"
