...
export function AdminUsersPage() {
  ...
  return (
    <AdminPageShell
      title="USERS"
      description="Create and invite accounts, change roles, grant features (including unpublished cards) without Stripe, disable or permanently delete users. Playtester is always public and is not listed here."
    >
